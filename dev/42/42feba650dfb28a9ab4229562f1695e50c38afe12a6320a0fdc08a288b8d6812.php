...
/* stagiaire.twig */
class __TwigTemplate_5ec03ff645100f0bb43dd520ac43d5b6b84aaa644b824da8bbd235cfca4735a6 extends Twig_Template
{
...
<section class=\"row stagiaire\">
    ...
    <div id=\"ajoutPeriode\" class=\"ajoutPeriode col-lg-12\" style=\"";
        // line 6
        echo twig_escape_filter($this->env, ($context["display_ajoutPeriode"] ?? null), "html", null, true);
        echo "\">

        <div id=\"periode\" class=\"periode block col-lg-offset-1 col-lg-10\" style=\"";
        // line 8
        echo twig_escape_filter($this->env, ($context["display_periode"] ?? null), "html", null, true);
        echo "\">
            <p>periode</p>
            ";
        // line 10
        ...
        // line 13
        echo twig_escape_filter($this->env, ($context["display_entreprise"] ?? null), "html", null, true);
        echo "\">
            <p>entreprise</p>
            ";
        // line 15
        ...
        // line 19
        echo twig_escape_filter($this->env, ($context["display_formEntrepriseComplete"] ?? null), "html", null, true);
        echo "\">
        ...
        // line 24
        echo twig_escape_filter($this->env, ($context["display_tuteur_liste"] ?? null), "html", null, true);
        echo "\">
            <p>tuteur_liste</p>
            ";
        // line 26
        ...
        // line 30
        echo twig_escape_filter($this->env, ($context["display_tuteur_modif"] ?? null), "html", null, true);
        echo "\">
            <p>tuteur_modif</p>
            ";
        // line 32
        ...
        // line 35
        echo twig_escape_filter($this->env, ($context["display_tuteur_ajout"] ?? null), "html", null, true);
        echo "\">
            <p>tuteur_ajout</p>
            ";
        // line 37
        ...
        // line 40
        echo twig_escape_filter($this->env, ($context["display_recap"] ?? null), "html", null, true);
        echo "\">
            <p>recap</p>
        </div>
    </div>
...
";
    ...
    {
        return new Twig_Source("", "stagiaire.twig", "C:\\wamp\\www\\gds_web3.1\\vues\\stagiaire.twig");
    }
}
